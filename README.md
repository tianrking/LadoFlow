...
| USB transport | Tested AOA 1/2 negotiation contract plus explicit Windows libusb discovery/mode-switch/interface-claim probe; no physical-device proof yet | Direct, authenticated device link |
